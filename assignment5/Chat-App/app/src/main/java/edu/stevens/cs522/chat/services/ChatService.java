...
public class ChatService extends Service implements IChatService, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onCreate() {
        ...
        chatPort = 6666;//prefs.getInt(SettingsActivity.APP_PORT_KEY, SettingsActivity.DEFAULT_APP_PORT);
    ...
    public void send(InetAddress destAddress, int destPort, String sender, String messageText, ResultReceiver receiver) {
        ...
        bundle.putString(MessageContract.ADDRESS, InetAddressUtils.fromIpAddress(destAddress));
    ...
    private final class SendHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            try {
                ...
                destAddr = InetAddressUtils.toIpAddress(bundle.getString(MessageContract.ADDRESS).substring(1));
                destPort = bundle.getInt(MessageContract.PORT);
                receiver = bundle.getParcelable(RECEIVER);
                sender = bundle.getString(MessageContract.SENDER);
