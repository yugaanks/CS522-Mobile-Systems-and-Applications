...
public class BookManager extends Manager<Book> {
    ...
    public void getAllBooksAsync(IQueryListener<Book> listener) {
       // contentResolver.queryAsync(CONTENT_URI,new String[] {"books._id","title","authors","isbn"},null,null,null,null);
    ...
    public void getBookAsync(long id, final IContinue<Book> callback) {
       //QueryBuilder.executeQuery(MainActivity.class.getCanonicalName(),this,new String[]{"books._id","title","authors","isbn"},null,new String[]{"title"},creator,listener);
